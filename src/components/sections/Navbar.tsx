    ...
    <nav className="fixed top-0 w-full z-50 nav-solid">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link href="/" aria-label={`${settings.hero_name || 'Vision Grid'} — home`} className="flex items-center">
          <span className="w-14 h-14 rounded-full overflow-hidden ring-1 ring-white/15 bg-white/5 flex items-center justify-center transition-transform duration-200 hover:scale-105">
            <img
              src="/logo-mark.png"
